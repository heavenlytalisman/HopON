...
import { View, Text, StyleSheet, TouchableOpacity, ActivityIndicator, Dimensions, SafeAreaView, Platform, ScrollView } from 'react-native';
...
export default function LoginScreen({ navigation }: RootStackScreenProps<'Login'>) {
  ...
  const renderIconBubble = (iconName: any) => (
    <View style={styles.iconBubbleContainer}>
      <BlurView intensity={20} tint="dark" style={styles.iconBubble}>
          ...
          <View style={styles.content}>
            ...
            <View style={styles.topSection}>
              ...
              <View style={styles.floatingIconsRow}>
                {renderIconBubble('people')}
                {renderIconBubble('game-controller')}
                {renderIconBubble('mic')}
                {renderIconBubble('chatbubble-ellipses')}
              </View>
            </View>
            ...
            <View style={styles.featuresSection}>
              ...
              <View style={styles.featureItem}>
                ...
                <View>
                  ...
                  <Text style={styles.featureDesc}>Hop on in seconds</Text>
                </View>
              </View>
              <View style={styles.featureItem}>
                <View style={styles.featureIconBox}>
                ...
                <View>
                  ...
                  <Text style={styles.featureDesc}>Squad is everything</Text>
                </View>
              </View>
            </View>
